...
var a = await axios.get(`https://api.lolhuman.xyz/api/nhentai/${budy}?apikey=Mythia-Chan`)
...
var pdf = await axios.get(`https://api.lolhuman.xyz/api/nhentaipdf/${budy}?apikey=Mythia-Chan`)
...
var a = await axios.get(`https://api.lolhuman.xyz/api/nhentaisearch?apikey=Mythia-Chan&query=${budy}`)
...
if (!isPremium) return reply(`khusus premium`)
 ...
 try {
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam1?apikey=Mythia-Chan&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam2?apikey=Mythia-Chan&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam3?apikey=Mythia-Chan&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam4?apikey=Mythia-Chan&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam5?apikey=Mythia-Chan&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam6?apikey=Mythia-Chan&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam7?apikey=Mythia-Chan&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam8?apikey=Mythia-Chan&nomor=${args[1]}`)
reply("Success")
 } catch (err) {
sendMess(ownerNumber, `${command} Error:` + err)
reply(mess.error.api)
...
if (args.length < 2) return reply(`Penggunaan ${command} emoji`)
  if (args.length === 2) {
 fetchJson(`https://api.lolhuman.xyz/api/smoji3/${encodeURIComponent(args[1])}?apikey=Mythia-Chan`)
 .then((res) =>{
let list = []
let startnum = 1
...
txt1 = args[0]
 txt2 = args[1]
 buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=Mythia-Chan&text1=${txt1}&text2=${txt2}`)
 buttons = [{buttonId: noprefix ? "menu" : "!"+"menu",buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await kahfzz.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'Kahfz Bot', imageMessage: imageMsg,
 contentText:`©WhatsApp bot`,buttons,headerType:4}
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
ini_txt = args.join(" ")
 buff = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=Mythia-Chan&text=${ini_txt}`)
 buttons = [{buttonId: noprefix ? "menu" : "!"+"menu",buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await kahfzz.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'KAHFZ BOT', imageMessage: imageMsg,
 contentText:`©WhatsApp bot`,buttons,headerType:4}
...
if (banChats === false) return
 uptime = process.uptime()
  ...
  break
  case 'quotes':
  quotes = await fetchJson(`https://api.lolhuman.xyz/api/random/quotes?apikey=Mythia-Chan`)
...
kahfzz.relayWAMessage(res)
  break
  case 'randomnama':
  anu = await fetchJson(`https://api.lolhuman.xyz/api/random/nama?apikey=Mythia-Chan`)
  kahfzi = anu.result
...
break
case 'ceritahoror':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/ceritahoror?apikey=Mythia-Chan`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
ini_txt += `Desc : ${get_result.desc}\n`
ini_txt += `Story :\n${get_result.story}\n`
...
case 'jadwaltv':
                    ...
                    channel = args[0]
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/jadwaltv/channel?apikey=Mythia-Chan`)
                    get_result = get_result.result
...
anu = await axios.get(`http://api.lolhuman.xyz/api/tebak/family100?apikey=Mythia-Chan`)
...
if (!q) return reply('Linknya?')
 ...
 data = await fetchJson(`https://api.lolhuman.xyz/api/tiktok?apikey=Mythia-Chan&url=${q}`)
...
try {
  henid = args[0]
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/nhentai/${henid}?apikey=Mythia-Chan`)
  get_result = get_result.result
  ...
  reply(mess.wait)
  anu = await fetchJson(`https://api.lolhuman.xyz/api/nhentaipdf/${henid}?apikey=Mythia-Chan`)
...
if (args.length == 0) return reply(`Example: ${prefix + command} Gotoubun No Hanayome`)
 reply(mess.wait)
  query = args.join(" ")
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/manga?apikey=Mythia-Chan&query=${query}`)
  get_result = get_result.result
...
reply(mess.wait)
 query = args.join(" ")
 get_result = await fetchJson(`https://api.lolhuman.xyz/api/anime?apikey=Mythia-Chan&query=${query}`)
 get_result = get_result.result
 ini_txt = `Id : ${get_result.id}\n`
 ini_txt += `Id MAL : ${get_result.idMal}\n`
 ini_txt += `Title : ${get_result.title.romaji}\n`
...
if (args.length == 0) return reply(`Example: ${prefix + command} Isekai Harem`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoisearch?apikey=Mythia-Chan&query=${query}`)
get_result = get_result.result
ini_txt = ""
for (var x of get_result) {
  ini_txt += `\`\`\`🐥 Title : ${x.title}\`\`\`\n`
...
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji/${emoji}?apikey=Mythia-Chan`)
...
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji3/${emoji}?apikey=Mythia-Chan`)
await kahfzz.sendMessage(from, ini_buffer, sticker, { quoted: freply })
case 'ttp':
case 'ttp2':
case 'ttp3':
